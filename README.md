...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytest-randomly-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytest-randomly-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pytest-randomly
# for installing globally
pixi global install pytest-randomly
```
...
It is possible to list all of the versions of `pytest-randomly` available on your platform:
...
```
pixi search pytest-randomly --channel conda-forge
```
